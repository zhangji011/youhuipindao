...
/***/ function(module, exports, __webpack_require__) {
	...
	document.querySelector('#formSubmitBtn').addEventListener('click', function () {
		_weui2.default.form.validate('#form', function (error) {
			var mTerminalNumber = document.getElementById("mTerminalNumber").value;
			var mMerchantName = document.getElementById("mMerchantName").value;
			var mMerchantAddress = document.getElementById("mMerchantAddress").value;
			var mUseName = document.getElementById("mUseName").value;
			// console.log(mUseName);
	        // if (mTerminalNumber && mMerchantName && mMerchantAddress && mUseName && imgStatus1 == 1 && imgStatus2 == 1) {
	...
	var	uploadCount1 = 0;
	var uploadCountDom = document.getElementById("uploadCount1");
	// 这里是简单的调用，其余api请参考文档
	_weui2.default.uploader('#uploaderCustom1', {
	    // url: 'http://localhost:8002/upload',
	    url: 'https://find.cmpay.com:9102/csxjServer/merchantXj/uploadPictures?flag=0',
	    // url: 'https://hbtest.letshappy.cn/csxjServer/merchantXj/uploadPictures?flag=0',
	    auto: true,
	    onBeforeQueued: function onBeforeQueued(files) {
	        if (["image/jpg", "image/jpeg", "image/png", "image/gif"].indexOf(this.type) < 0) {
	            _weui2.default.alert('请上传图片');
	        ...
	        if (files.length > 3) {
	            // 防止一下子选中过多文件
	            _weui2.default.alert('最多只能上传3张图片，请重新选择');
	            return false;
	        }
	        if (uploadCount1 + 1 > 3) {
	            _weui2.default.alert('最多只能上传3张图片');
	            return false;
	        }

	        ++uploadCount1;
	        // uploadCountDom.innerHTML = uploadCount1;
	    },
	    onQueued: function onQueued() {
		...
		onSuccess: function onSuccess(ret) {
			...
			// _weui2.default.toast('提交成功');
	    }
	});
	// var images = dataId;
	var uploadCustomFileList2 = [];
	var	uploadCount2 = 0;
	var uploadCountDom = document.getElementById("uploadCount2");
	_weui2.default.uploader('#uploaderCustom2', {
	    // url: 'http://localhost:8002/upload',
	    url: 'https://find.cmpay.com:9102/csxjServer/merchantXj/uploadPictures?flag=1',
	    // url: 'https://hbtest.letshappy.cn/csxjServer/merchantXj/uploadPictures?flag=1',
	    auto: true,
	    onBeforeQueued: function onBeforeQueued(files) {
	        if (["image/jpg", "image/jpeg", "image/png", "image/gif"].indexOf(this.type) < 0) {
	            _weui2.default.alert('请上传图片');
	        ...
	        ++uploadCount2;
	        // uploadCountDom.innerHTML = uploadCount2;
	    },
	    onQueued: function onQueued() {
	...
	var	uploadCount3 = 0;
	var uploadCountDom = document.getElementById("uploadCount3");
	_weui2.default.uploader('#uploaderCustom3', {
	    // url: 'http://localhost:8002/upload',
	    url: 'https://find.cmpay.com:9102/csxjServer/merchantXj/uploadPictures?flag=2',
	    // url: 'https://hbtest.letshappy.cn/csxjServer/merchantXj/uploadPictures?flag=2',
	    auto: true,
	    onBeforeQueued: function onBeforeQueued(files) {
	        if (["image/jpg", "image/jpeg", "image/png", "image/gif"].indexOf(this.type) < 0) {
	            _weui2.default.alert('请上传图片');
	...
	document.querySelector('#uploaderCustomFiles3').addEventListener('click', function (e) {
	    var target = e.target;
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\" <%= className %>\" style=display:block></div> ";
