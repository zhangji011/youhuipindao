...
export default {
	...
	[ANIMATION](state, data){
		if(data){
			state['animation'][data.key] = data.value
		}else{
			state['animation'] = {}
		}
	},
	[HISTORYCOUNT](state, data){
		state['historyCount'] = data
	},
	[ALERTTEXTFIRST](state, data){
		state['alertTextFirst'] = data
	},
	[ALERTTEXTSECOND](state, data){
		state['alertTextSecond'] = data
	},
	[ISSHOWALERT](state, data){
		state['isShowAlert'] = data
	},
	[BTNTEXT](state, data){
		state['btnText'] = data
	},
	[ISADMITTANCE](state, data){
		state['isAdmittance'] = data
	},
	[SHOWLOADING](state, data){
		state['showLoading'] = data
	},
	[SLIDERSCROLL](state, data){
		state['sliderScroll'] = data
	},
