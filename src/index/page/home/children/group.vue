...
export default {
  ...
  methods: {
    ...
    gouClick() {
      Cookies.set("groupp",JSON.stringify(2))
      window.location.href = 'https://click.k.jd.com/union?&mtm_source=kepler-m&mtm_subsource=d755c07d47ad4d2cbc2c7c3e0f23d660&returl=https%3A%2F%2Fu.jd.com%2FPtKX4x'
    }
  },
  watch:{
