      ...
      <scroll>
        ...
        <div class="content">
          <div class="content-info">
            <div class="list-info">活动时间：<span>{{drawList.effDt}}</span> 到 <span>{{drawList.expDt}}</span></div>
            <div class="list-info">参与时间：<span>{{drawList.attEffTm}}</span> 到 <span>{{drawList.attExpTm}}</span></div>
            <div class="list-info">
